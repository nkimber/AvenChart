...
Status: Exact disabled synthetic Sprints 1–50 active only within Decisions 0003 and 0005–0053
...
Current increment: [Sprint 50 applicant request participation evaluation](sprint-50-applicant-request-participation-evaluation.md); bounded automated implementation evidence is recorded in the [Sprint 50 evidence packet](sprint-50-evidence.md)
...
- Decisions 0003 and 0005–0053 authorize only their exact disabled synthetic Sprint 1–50 application/database/feature-test/runtime paths through 2026-10-31.
