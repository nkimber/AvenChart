...
Status: Exact disabled synthetic Sprints 1–51 active only within Decisions 0003 and 0005–0054
...
Current increment: [Sprint 51 applicant request operational-review submission](sprint-51-applicant-request-operational-review-submission.md); bounded automated implementation evidence is recorded in the [Sprint 51 evidence packet](sprint-51-evidence.md)
...
- Decisions 0003 and 0005–0054 authorize only their exact disabled synthetic Sprint 1–51 application/database/feature-test/runtime paths through 2026-10-31.
