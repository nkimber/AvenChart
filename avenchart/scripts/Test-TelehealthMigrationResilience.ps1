...
try {
    if (-not $SkipBaseRehearsal) {
        ...
        Add-Check 'Repository empty, populated, interruption, and recovery rehearsal includes V0282 through V0325' ($LASTEXITCODE -eq 0)
    }
    else {
