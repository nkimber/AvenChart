...
try {
  ...
  Add-Check 'Idle shift end rejects an absent staff identity' ((Invoke-Status 'POST' '/api/telehealth/v1/clinician/shifts/aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa/end' @{} @{expectedVersion=1;noActiveWorkConfirmed=$true;syntheticEndConfirmed=$true}) -eq 401)
