...
Status: Exact disabled synthetic Sprints 1–54 active only within Decisions 0003 and 0005–0057
...
Current increment: [Sprint 54 applicant request clinician reservation](sprint-54-applicant-request-clinician-reservation.md); bounded automated implementation evidence is recorded in the [Sprint 54 evidence packet](sprint-54-evidence.md)
...
- Decisions 0003 and 0005–0057 authorize only their exact disabled synthetic Sprint 1–54 application/database/feature-test/runtime paths through 2026-10-31.
