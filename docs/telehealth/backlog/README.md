...
Status: Exact disabled synthetic Sprints 1–56 active only within Decisions 0003 and 0005–0059
...
Current increment: [Sprint 56 applicant clinician connection and consultation start](sprint-56-applicant-consultation-start.md); bounded automated implementation evidence is being recorded in the [Sprint 56 evidence packet](sprint-56-evidence.md)
...
- Decisions 0003 and 0005–0059 authorize only their exact disabled synthetic Sprint 1–56 application/database/feature-test/runtime paths through 2026-10-31.
