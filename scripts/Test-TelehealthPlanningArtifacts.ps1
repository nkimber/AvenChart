...
if ($null -ne $backlog) {
    ...
    Add-ValidationCheck -Name 'Backlog schema and baseline decision are current' -Passed (
        ...
        (Get-PropertyValue -Object $backlog -Name 'implementationAuthorization') -eq 'disabled-synthetic-sprints-01-through-41-authorized-by-th-dec-0003-and-th-dec-0005-through-th-dec-0044-through-2026-10-31; all-other-feature-code-blocked-by-phase-2-exit-gate'
...
if ($null -ne $safeguards) {
    ...
    $expectedSafeguardIds = @(1..46 | ForEach-Object { 'TH-SG-{0:D3}' -f $_ })
    ...
    Add-ValidationCheck -Name 'Safeguard manifest records the scoped Decision 0002, 0003, 0005 through 0044 activation' -Passed (
        (Get-PropertyValue -Object $safeguards -Name 'schemaVersion') -eq 1 -and
        (Get-PropertyValue -Object $safeguards -Name 'status') -eq 'active-for-decisions-0003-0005-through-0044-synthetic-sprints-01-through-41' -and
        (Get-PropertyValue -Object $safeguards -Name 'activationPrerequisite') -eq 'Active only for the exact disabled synthetic Sprints 1 through 41 scopes and paths in TH-DEC-0003 and TH-DEC-0005 through TH-DEC-0044 through 2026-10-31' -and
        (Test-ExactSet -Actual @(Get-PropertyValue -Object $safeguards -Name 'authorizationDecisions') -Expected @('TH-DEC-0002', 'TH-DEC-0003', 'TH-DEC-0005', 'TH-DEC-0006', 'TH-DEC-0007', 'TH-DEC-0008', 'TH-DEC-0009', 'TH-DEC-0010', 'TH-DEC-0011', 'TH-DEC-0012', 'TH-DEC-0013', 'TH-DEC-0014', 'TH-DEC-0015', 'TH-DEC-0016', 'TH-DEC-0017', 'TH-DEC-0018', 'TH-DEC-0019', 'TH-DEC-0020', 'TH-DEC-0021', 'TH-DEC-0022', 'TH-DEC-0023', 'TH-DEC-0024', 'TH-DEC-0025', 'TH-DEC-0026', 'TH-DEC-0027', 'TH-DEC-0028', 'TH-DEC-0029', 'TH-DEC-0030', 'TH-DEC-0031', 'TH-DEC-0032', 'TH-DEC-0033', 'TH-DEC-0034', 'TH-DEC-0035', 'TH-DEC-0036', 'TH-DEC-0037', 'TH-DEC-0038', 'TH-DEC-0039', 'TH-DEC-0040', 'TH-DEC-0041', 'TH-DEC-0042', 'TH-DEC-0043', 'TH-DEC-0044')) -and
    ...
    Add-ValidationCheck -Name 'Forty-six safeguards have unique complete identifiers and complete definitions' -Passed (
        $safeguardIds.Count -eq 46 -and
        @($safeguardIds | Sort-Object -Unique).Count -eq 46 -and
        (Test-ExactSet -Actual $safeguardIds -Expected $expectedSafeguardIds) -and
        @($requiredPaths | Where-Object { -not [string]::IsNullOrWhiteSpace($_) }).Count -eq 46 -and
