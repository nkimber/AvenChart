...
function blankInput(): PatientSdohAssessmentInput {
  return { assessmentDate: new Date().toISOString().slice(0, 10), screeningTool: '', assessor: '', domains: {}, hungerQuestionOne: '', hungerQuestionTwo: '', pregnancyStatus: '', pregnancyEdd: '', pregnancyIntent: '', postpartumStatus: '', postpartumEnd: '', interventions: '' }
}
