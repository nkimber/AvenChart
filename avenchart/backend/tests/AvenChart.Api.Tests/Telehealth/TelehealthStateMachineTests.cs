...
public sealed class TelehealthStateMachineTests
{
    public static TheoryData<TelehealthRequestStatus, TelehealthRequestStatus> AllowedTransitions => new()
    {
        ...
        { TelehealthRequestStatus.Draft, TelehealthRequestStatus.Cancelled },
        ...
        { TelehealthRequestStatus.LocationConfirmed, TelehealthRequestStatus.SafetyScreening },
        { TelehealthRequestStatus.LocationConfirmed, TelehealthRequestStatus.EmergencyRedirected },
        { TelehealthRequestStatus.LocationConfirmed, TelehealthRequestStatus.InPersonRecommended },
        { TelehealthRequestStatus.LocationConfirmed, TelehealthRequestStatus.ClinicalReview },
        { TelehealthRequestStatus.LocationConfirmed, TelehealthRequestStatus.Cancelled },
        { TelehealthRequestStatus.SafetyScreening, TelehealthRequestStatus.EmergencyRedirected },
        { TelehealthRequestStatus.SafetyScreening, TelehealthRequestStatus.InPersonRecommended },
        { TelehealthRequestStatus.SafetyScreening, TelehealthRequestStatus.Unsupported },
        { TelehealthRequestStatus.SafetyScreening, TelehealthRequestStatus.ClinicalReview },
        { TelehealthRequestStatus.SafetyScreening, TelehealthRequestStatus.Intake },
        { TelehealthRequestStatus.SafetyScreening, TelehealthRequestStatus.Cancelled },
        { TelehealthRequestStatus.Intake, TelehealthRequestStatus.Verification },
        { TelehealthRequestStatus.Intake, TelehealthRequestStatus.Cancelled },
        ...
        { TelehealthRequestStatus.Verification, TelehealthRequestStatus.Cancelled },
