...
Status: Exact disabled synthetic Sprints 1–49 active only within Decisions 0003 and 0005–0052
...
Current increment: [Sprint 49 applicant request participation context](sprint-49-applicant-request-participation-context.md); bounded automated implementation evidence is recorded in the [Sprint 49 evidence packet](sprint-49-evidence.md)
...
- Decisions 0003 and 0005–0052 authorize only their exact disabled synthetic Sprint 1–49 application/database/feature-test/runtime paths through 2026-10-31.
