...
$decisionFiftyFivePath = Join-Path $telehealthRoot 'decisions/0055-approved-sprint-52-applicant-request-queue-authorization.md'
$decisionFiftySixPath = Join-Path $telehealthRoot 'decisions/0056-approved-sprint-53-applicant-request-queue-status.md'
$decisionFiftySevenPath = Join-Path $telehealthRoot 'decisions/0057-approved-sprint-54-applicant-request-clinician-reservation.md'
...
$decisionSixtyTwoPath = Join-Path $telehealthRoot 'decisions/0062-approved-sprint-59-synthetic-final-clinical-review.md'
...
$sprintFiftyTwoPath = Join-Path $telehealthRoot 'backlog/sprint-52-applicant-request-queue-authorization.md'
$sprintFiftyTwoEvidencePath = Join-Path $telehealthRoot 'backlog/sprint-52-evidence.md'
$sprintFiftyThreePath = Join-Path $telehealthRoot 'backlog/sprint-53-applicant-request-queue-status.md'
$sprintFiftyThreeEvidencePath = Join-Path $telehealthRoot 'backlog/sprint-53-evidence.md'
$sprintFiftyFourPath = Join-Path $telehealthRoot 'backlog/sprint-54-applicant-request-clinician-reservation.md'
$sprintFiftyFourEvidencePath = Join-Path $telehealthRoot 'backlog/sprint-54-evidence.md'
$sprintFiftyFivePath = Join-Path $telehealthRoot 'backlog/sprint-55-applicant-request-connection-room.md'
$sprintFiftyFiveEvidencePath = Join-Path $telehealthRoot 'backlog/sprint-55-evidence.md'
$sprintFiftySixPath = Join-Path $telehealthRoot 'backlog/sprint-56-applicant-consultation-start.md'
...
$sprintFiftyNinePath = Join-Path $telehealthRoot 'backlog/sprint-59-synthetic-final-clinical-review.md'
$sprintFiftyNineEvidencePath = Join-Path $telehealthRoot 'backlog/sprint-59-evidence.md'
$sprintSixtyPath = Join-Path $telehealthRoot 'backlog/sprint-60-synthetic-encounter-finalization.md'
$sprintSixtyEvidencePath = Join-Path $telehealthRoot 'backlog/sprint-60-evidence.md'
$sprintSixtyOnePath = Join-Path $telehealthRoot 'backlog/sprint-61-synthetic-visit-closure.md'
...
$requiredFiles = @(
    ...
    $decisionFiftyFivePath,
    $decisionFiftySixPath,
    $decisionFiftySevenPath,
    $decisionFiftyEightPath,
    $decisionFiftyNinePath,
    $decisionSixtyPath,
    $decisionSixtyOnePath,
    $decisionSixtyTwoPath,
    ...
    $sprintFiftyTwoPath,
    $sprintFiftyTwoEvidencePath,
    $sprintFiftyThreePath,
    $sprintFiftyThreeEvidencePath,
    $sprintFiftyFourPath,
    $sprintFiftyFourEvidencePath,
    $sprintFiftyFivePath,
    $sprintFiftyFiveEvidencePath,
    $sprintFiftySixPath,
    ...
    $sprintFiftyNinePath,
    $sprintFiftyNineEvidencePath,
    $sprintSixtyPath,
    $sprintSixtyEvidencePath,
    $sprintSixtyOnePath,
...
if ($null -ne $backlog) {
    ...
    Add-ValidationCheck -Name 'Backlog schema and baseline decision are current' -Passed (
        ...
        (Get-PropertyValue -Object $backlog -Name 'implementationAuthorization') -eq 'disabled-synthetic-sprints-01-through-68-authorized-by-th-dec-0003-and-th-dec-0005-through-th-dec-0071-through-2026-10-31; all-other-feature-code-blocked-by-phase-2-exit-gate'
...
if ($null -ne $safeguards) {
    ...
    $expectedSafeguardIds = @(1..67 | ForEach-Object { 'TH-SG-{0:D3}' -f $_ })
    ...
    Add-ValidationCheck -Name 'Safeguard manifest records the scoped Decision 0002, 0003, 0005 through 0066 activation' -Passed (
        (Get-PropertyValue -Object $safeguards -Name 'schemaVersion') -eq 1 -and
        (Get-PropertyValue -Object $safeguards -Name 'status') -eq 'active-for-decisions-0003-0005-through-0066-synthetic-sprints-01-through-63' -and
        (Get-PropertyValue -Object $safeguards -Name 'activationPrerequisite') -eq 'Active only for the exact disabled synthetic Sprints 1 through 63 scopes and paths in TH-DEC-0003 and TH-DEC-0005 through TH-DEC-0066 through 2026-10-31' -and
        (Test-ExactSet -Actual @(Get-PropertyValue -Object $safeguards -Name 'authorizationDecisions') -Expected @('TH-DEC-0002', 'TH-DEC-0003', 'TH-DEC-0005', 'TH-DEC-0006', 'TH-DEC-0007', 'TH-DEC-0008', 'TH-DEC-0009', 'TH-DEC-0010', 'TH-DEC-0011', 'TH-DEC-0012', 'TH-DEC-0013', 'TH-DEC-0014', 'TH-DEC-0015', 'TH-DEC-0016', 'TH-DEC-0017', 'TH-DEC-0018', 'TH-DEC-0019', 'TH-DEC-0020', 'TH-DEC-0021', 'TH-DEC-0022', 'TH-DEC-0023', 'TH-DEC-0024', 'TH-DEC-0025', 'TH-DEC-0026', 'TH-DEC-0027', 'TH-DEC-0028', 'TH-DEC-0029', 'TH-DEC-0030', 'TH-DEC-0031', 'TH-DEC-0032', 'TH-DEC-0033', 'TH-DEC-0034', 'TH-DEC-0035', 'TH-DEC-0036', 'TH-DEC-0037', 'TH-DEC-0038', 'TH-DEC-0039', 'TH-DEC-0040', 'TH-DEC-0041', 'TH-DEC-0042', 'TH-DEC-0043', 'TH-DEC-0044', 'TH-DEC-0045', 'TH-DEC-0046', 'TH-DEC-0047', 'TH-DEC-0048', 'TH-DEC-0049', 'TH-DEC-0050', 'TH-DEC-0051', 'TH-DEC-0052', 'TH-DEC-0053', 'TH-DEC-0054', 'TH-DEC-0055', 'TH-DEC-0056', 'TH-DEC-0057', 'TH-DEC-0058', 'TH-DEC-0059', 'TH-DEC-0060', 'TH-DEC-0061', 'TH-DEC-0062', 'TH-DEC-0063', 'TH-DEC-0064', 'TH-DEC-0065', 'TH-DEC-0066')) -and
    ...
    Add-ValidationCheck -Name 'Sixty-seven safeguards have unique complete identifiers and complete definitions' -Passed (
        $safeguardIds.Count -eq 67 -and
        @($safeguardIds | Sort-Object -Unique).Count -eq 67 -and
        (Test-ExactSet -Actual $safeguardIds -Expected $expectedSafeguardIds) -and
        @($requiredPaths | Where-Object { -not [string]::IsNullOrWhiteSpace($_) }).Count -eq 67 -and
...
$decisionFiftyFive = if (Test-Path -LiteralPath $decisionFiftyFivePath -PathType Leaf) { Get-Content -Raw -LiteralPath $decisionFiftyFivePath } else { '' }
$decisionFiftySix = if (Test-Path -LiteralPath $decisionFiftySixPath -PathType Leaf) { Get-Content -Raw -LiteralPath $decisionFiftySixPath } else { '' }
$decisionFiftySeven = if (Test-Path -LiteralPath $decisionFiftySevenPath -PathType Leaf) { Get-Content -Raw -LiteralPath $decisionFiftySevenPath } else { '' }
...
$decisionSixtyTwo = if (Test-Path -LiteralPath $decisionSixtyTwoPath -PathType Leaf) { Get-Content -Raw -LiteralPath $decisionSixtyTwoPath } else { '' }
...
$decisionFiftyFiveExpiryMatch = [regex]::Match($decisionFiftyFive, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
$decisionFiftyFiveExpiryDate = if ($decisionFiftyFiveExpiryMatch.Success) { [DateTime]::ParseExact($decisionFiftyFiveExpiryMatch.Groups[1].Value, 'yyyy-MM-dd', [Globalization.CultureInfo]::InvariantCulture) } else { [DateTime]::MinValue }
$decisionFiftySixExpiryMatch = [regex]::Match($decisionFiftySix, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
$decisionFiftySixExpiryDate = if ($decisionFiftySixExpiryMatch.Success) { [DateTime]::ParseExact($decisionFiftySixExpiryMatch.Groups[1].Value, 'yyyy-MM-dd', [Globalization.CultureInfo]::InvariantCulture) } else { [DateTime]::MinValue }
$decisionFiftySevenExpiryMatch = [regex]::Match($decisionFiftySeven, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
$decisionFiftySevenExpiryDate = if ($decisionFiftySevenExpiryMatch.Success) { [DateTime]::ParseExact($decisionFiftySevenExpiryMatch.Groups[1].Value, 'yyyy-MM-dd', [Globalization.CultureInfo]::InvariantCulture) } else { [DateTime]::MinValue }
$decisionFiftyEightExpiryMatch = [regex]::Match($decisionFiftyEight, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
$decisionFiftyEightExpiryDate = if ($decisionFiftyEightExpiryMatch.Success) { [DateTime]::ParseExact($decisionFiftyEightExpiryMatch.Groups[1].Value, 'yyyy-MM-dd', [Globalization.CultureInfo]::InvariantCulture) } else { [DateTime]::MinValue }
$decisionFiftyNineExpiryMatch = [regex]::Match($decisionFiftyNine, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
...
$decisionSixtyTwoExpiryMatch = [regex]::Match($decisionSixtyTwo, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
$decisionSixtyTwoExpiryDate = if ($decisionSixtyTwoExpiryMatch.Success) { [DateTime]::ParseExact($decisionSixtyTwoExpiryMatch.Groups[1].Value, 'yyyy-MM-dd', [Globalization.CultureInfo]::InvariantCulture) } else { [DateTime]::MinValue }
$decisionSixtyThreeExpiryMatch = [regex]::Match($decisionSixtyThree, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
$decisionSixtyThreeExpiryDate = if ($decisionSixtyThreeExpiryMatch.Success) { [DateTime]::ParseExact($decisionSixtyThreeExpiryMatch.Groups[1].Value, 'yyyy-MM-dd', [Globalization.CultureInfo]::InvariantCulture) } else { [DateTime]::MinValue }
$decisionSixtyFourExpiryMatch = [regex]::Match($decisionSixtyFour, '(?m)^Review/expiry:\s*(\d{4}-\d{2}-\d{2})')
...
if ($TestMutation -eq 'ExpireDecision') {
    ...
    $decisionFiftyFiveExpiryDate = [DateTime]::MinValue
    $decisionFiftySixExpiryDate = [DateTime]::MinValue
    $decisionFiftySevenExpiryDate = [DateTime]::MinValue
    ...
    $decisionSixtyTwoExpiryDate = [DateTime]::MinValue
...
Add-ValidationCheck -Name 'Decision 0055 approves only administrator acceptance of one applicant request into the disabled synthetic clinician queue while real coverage, assignment, encounter, consent, and care gates remain closed' -Passed (
    $decisionFiftyFive -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionFiftyFive -match '(?m)^Approved date: 2026-08-29\s*$' -and
    $decisionFiftyFive -match 'SYNTHETIC_APPLICANT_REQUEST_QUEUE_AUTHORIZATION' -and
    $decisionFiftyFive -match '`OperationalReview` version 12' -and
    $decisionFiftyFive -match '`Queued` version 13' -and
    $decisionFiftyFive -match 'four explicit true values' -and
    $decisionFiftyFive -match 'one unassigned synthetic appointment' -and
    $decisionFiftyFive -match 'generic established-patient authorization route explicitly rejects applicant-originated requests' -and
    $decisionFiftyFive -match 'patient queue-status access' -and
    $decisionFiftyFive -match 'This decision does not authorize' -and
    $decisionFiftyFiveExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionFiftyFiveExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0055'; expires = if ($decisionFiftyFiveExpiryMatch.Success) { $decisionFiftyFiveExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0056 approves only applicant-owned read-only operational-review and queued status with approximate ordering while clinician assignment and every care gate remain closed' -Passed (
    $decisionFiftySix -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionFiftySix -match '(?m)^Approved date: 2026-08-29\s*$' -and
    $decisionFiftySix -match 'SYNTHETIC_APPLICANT_REQUEST_QUEUE_STATUS' -and
    $decisionFiftySix -match '`OperationalReview` version 12' -and
    $decisionFiftySix -match '`Queued` version 13' -and
    $decisionFiftySix -match 'approximate count of same-practice, same-facility `Ready` requests' -and
    $decisionFiftySix -match 'not an assigned queue position' -and
    $decisionFiftySix -match 'authoritative HTTP' -and
    $decisionFiftySix -match 'does not expose later clinician reservation' -and
    $decisionFiftySix -match 'This decision does not authorize' -and
    $decisionFiftySixExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionFiftySixExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0056'; expires = if ($decisionFiftySixExpiryMatch.Success) { $decisionFiftySixExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0057 approves only exact synthetic candidate reservation of an applicant-originated request while identity disclosure and every care gate remain closed' -Passed (
    $decisionFiftySeven -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionFiftySeven -match '(?m)^Approved date: 2026-08-29\s*$' -and
    $decisionFiftySeven -match 'exactly matches the current applicant request' -and
    $decisionFiftySeven -match 'candidate_staff_id' -and
    $decisionFiftySeven -match '`Ready -> Reserved`' -and
    $decisionFiftySeven -match '`Queued -> Reserved`' -and
    $decisionFiftySeven -match 'FOR UPDATE SKIP LOCKED' -and
    $decisionFiftySeven -match '`Reserved`/`PhysicianPreparing`' -and
    $decisionFiftySeven -match 'must not expose the applicant access key' -and
    $decisionFiftySeven -match 'This decision does not authorize' -and
    $decisionFiftySevenExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionFiftySevenExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0057'; expires = if ($decisionFiftySevenExpiryMatch.Success) { $decisionFiftySevenExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0058 approves only applicant-owned private synthetic waiting-room preparation while media, communication, consultation, consent, encounter, and care remain closed' -Passed (
    $decisionFiftyEight -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionFiftyEight -match '(?m)^Approved date: 2026-08-29\s*$' -and
    $decisionFiftyEight -match 'SYNTHETIC_APPLICANT_CONNECTION_ROOM' -and
    $decisionFiftyEight -match '`Reserved` to `Connecting`' -and
    $decisionFiftyEight -match 'appointment `Arrived`' -and
    $decisionFiftyEight -match 'domain-separated participant subject hash' -and
    $decisionFiftyEight -match 'Temporary camera and microphone tracks' -and
    $decisionFiftyEight -match 'media transport, recording, and transcription remain false' -and
    $decisionFiftyEight -match 'must not render or persist the credential' -and
    $decisionFiftyEight -match 'This decision does not authorize' -and
    $decisionFiftyEightExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionFiftyEightExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0058'; expires = if ($decisionFiftyEightExpiryMatch.Success) { $decisionFiftyEightExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0059 approves exact-owner applicant clinician connection and bounded consultation start while real media, consent, coverage, treatment, and downstream gates remain closed' -Passed (
    $decisionFiftyNine -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionFiftyNine -match '(?m)^Approved date: 2026-08-29\s*$' -and
    $decisionFiftyNine -match 'SYNTHETIC_APPLICANT_CONSULTATION_START' -and
    $decisionFiftyNine -match '`Connecting` to `InConsultation`' -and
    $decisionFiftyNine -match 'exact Sprint 52 queue authorization' -and
    $decisionFiftyNine -match 'no-coverage-guarantee' -and
    $decisionFiftyNine -match 'active, unmerged, living adult patient state' -and
    $decisionFiftyNine -match 'both short-lived participant grants' -and
    $decisionFiftyNine -match 'bounded workspace' -and
    $decisionFiftyNine -match 'This decision does not authorize' -and
    $decisionFiftyNineExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionFiftyNineExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0059'; expires = if ($decisionFiftyNineExpiryMatch.Success) { $decisionFiftyNineExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0060 approves exact-owner applicant wrap-up and bounded planning while signing, prescribing, delivery, completion, claims, integrations, and external action remain closed' -Passed (
    $decisionSixty -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionSixty -match '(?m)^Approved date: 2026-08-29\s*$' -and
    $decisionSixty -match '`MediaEnded` consultation' -and
    $decisionSixty -match '`WrapUp` request' -and
    $decisionSixty -match 'expired applicant access session' -and
    $decisionSixty -match 'non-controlled catalog' -and
    $decisionSixty -match 'completion-prerequisites review' -and
    $decisionSixty -match 'permanent product blockers' -and
    $decisionSixty -match 'minimized `WrapUp`' -and
...
Add-ValidationCheck -Name 'Decision 0062 approves exact-owner synthetic final clinical-review evidence while signature, completion, delivery, billing, claims, and external action remain closed' -Passed (
    $decisionSixtyTwo -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionSixtyTwo -match '(?m)^Approved date: 2026-08-30\s*$' -and
    $decisionSixtyTwo -match 'current complete SOAP draft' -and
    $decisionSixtyTwo -match 'safety-disposition draft' -and
    $decisionSixtyTwo -match 'no automated sufficiency' -and
    $decisionSixtyTwo -match 'Idempotent retry' -and
    $decisionSixtyTwo -match 'not a legal signature' -and
    $decisionSixtyTwo -match 'This decision does not authorize' -and
    $decisionSixtyTwoExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionSixtyTwoExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0062'; expires = if ($decisionSixtyTwoExpiryMatch.Success) { $decisionSixtyTwoExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0063 approves exact-owner synthetic encounter finalization while completion, release, delivery, billing, claims, and external action remain closed' -Passed (
    $decisionSixtyThree -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionSixtyThree -match '(?m)^Approved date: 2026-08-30\s*$' -and
    $decisionSixtyThree -match 'governed encounter-lock mechanism' -and
    $decisionSixtyThree -match 'current signed-prescription order identifier' -and
    $decisionSixtyThree -match 'not a legally effective signature' -and
    $decisionSixtyThree -match 'clinician release' -and
    $decisionSixtyThree -match 'This decision does not authorize' -and
    $decisionSixtyThreeExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionSixtyThreeExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0063'; expires = if ($decisionSixtyThreeExpiryMatch.Success) { $decisionSixtyThreeExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0064 approves exact-owner synthetic visit closure while appointment completion, delivery, billing, claims, and external action remain closed' -Passed (
    $decisionSixtyFour -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionSixtyFour -match '(?m)^Approved date: 2026-08-30\s*$' -and
    $decisionSixtyFour -match 'governed encounter lock' -and
    $decisionSixtyFour -match 'appointment remains in progress' -and
    $decisionSixtyFour -match 'Semantic replay' -and
    $decisionSixtyFour -match 'This decision does not authorize' -and
    $decisionSixtyFourExpiryMatch.Success -and [DateTime]::UtcNow.Date -le $decisionSixtyFourExpiryDate.Date
) -Details @{ decision = 'TH-DEC-0064'; expires = if ($decisionSixtyFourExpiryMatch.Success) { $decisionSixtyFourExpiryMatch.Groups[1].Value } else { $null } }
Add-ValidationCheck -Name 'Decision 0065 approves owner-scoped synthetic closure status while appointment completion, delivery, billing, claims, and external action remain closed' -Passed (
    $decisionSixtyFive -match '(?m)^Status: Approved — active for the exact disabled synthetic slice below\s*$' -and
    $decisionSixtyFive -match '(?m)^Approved date: 2026-08-30\s*$' -and
    $decisionSixtyFive -match 'appointment and encounter remain incomplete' -and
    $decisionSixtyFive -match 'terminal for browser polling' -and
