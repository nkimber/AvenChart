...
export type PatientSdohAssessment = { assessmentId: string; patientId: string; legacyPid: number; assessmentDate: string; screeningTool?: string | null; assessor: string; instrumentScore: number; hungerQuestionOne?: string | null; hungerQuestionTwo?: string | null; hungerScore: number; domains: Record<string, PatientSdohDomainValue>; interventions?: string | null; createdAt: string; createdBy: string; updatedAt: string; updatedBy: string }
export type PatientSdohAssessmentInput = { assessmentDate: string; screeningTool?: string; assessor?: string; domains: Record<string, PatientSdohDomainValue>; hungerQuestionOne?: string; hungerQuestionTwo?: string; interventions?: string }
