...
Status: Exact disabled synthetic Sprints 1–55 active only within Decisions 0003 and 0005–0058
...
Current increment: [Sprint 55 applicant request connection room](sprint-55-applicant-request-connection-room.md); bounded automated implementation evidence is being recorded in the [Sprint 55 evidence packet](sprint-55-evidence.md)
...
- Decisions 0003 and 0005–0058 authorize only their exact disabled synthetic Sprint 1–55 application/database/feature-test/runtime paths through 2026-10-31.
