...
Status: Exact disabled synthetic Sprints 1–75 active only within Decisions 0003 and 0005–0078
...
Current increment: [Sprint 75 POC patient queued-request withdrawal](sprint-75-poc-patient-queued-request-withdrawal.md); implementation and automated evidence passed
