...
if ($null -ne $backlog) {
    ...
    Add-ValidationCheck -Name 'Backlog schema and baseline decision are current' -Passed (
        ...
        (Get-PropertyValue -Object $backlog -Name 'implementationAuthorization') -eq 'disabled-synthetic-sprints-01-through-70-authorized-by-th-dec-0003-and-th-dec-0005-through-th-dec-0073-through-2026-10-31; all-other-feature-code-blocked-by-phase-2-exit-gate'
