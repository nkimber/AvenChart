...
public static class TelehealthServiceRegistration
{
        ...
        IHostEnvironment environment)
    {
        ...
        services.AddScoped<TelehealthApplicantRequestQueueAuthorizationRepository>();
        services.AddScoped<TelehealthApplicantRequestQueueAuthorizationService>();
        services.AddScoped<TelehealthApplicantRequestQueueStatusRepository>();
        services.AddScoped<TelehealthApplicantRequestQueueStatusService>();
        services.AddScoped<TelehealthApplicantQueuedRequestWithdrawalRepository>();
        services.AddScoped<TelehealthApplicantQueuedRequestWithdrawalService>();
        ...
        services.AddScoped<TelehealthFinalClinicalReviewRepository>();
        services.AddScoped<TelehealthFinalClinicalReviewService>();
        services.AddScoped<TelehealthEncounterFinalizationRepository>();
        ...
        services.AddScoped<TelehealthSyntheticAfterVisitPlanPreviewRepository>();
        services.AddScoped<TelehealthSyntheticAfterVisitPlanPreviewService>();
