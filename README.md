...
Phase 2 assessment governance is maintained under [`docs/phase-2/`](docs/phase-2/README.md). It defines the production-oriented quality standard, coverage matrix, evidence and decision templates, read-only specialist agent model, and accepted calibration contract used by the full assessment. Full packets now cover [identity, authorization, session lifecycle, browser persistence, and PHI audit](docs/phase-2/assessments/cov-002-identity-authorization-phi-audit.md), [patient identity, demographics, merge, lifecycle, chart context, and SDOH](docs/phase-2/assessments/cov-003-patient-identity-lifecycle.md), [encounters and clinical records](docs/phase-2/assessments/cov-004-encounter-clinical-records.md), [scheduling and communications](docs/phase-2/assessments/cov-005-scheduling-communications.md), [laboratories, procedures, critical-result acknowledgement, and follow-up](docs/phase-2/assessments/cov-006-laboratories-procedures.md), [billing, controlled inventory, administration, reporting, and background execution](docs/phase-2/assessments/cov-007-billing-inventory-administration-reporting.md), [API contracts, FHIR, transport, and reconciliation](docs/phase-2/assessments/cov-010-api-contracts-fhir-transport-reconciliation.md), [modern clinician interface and accessibility](docs/phase-2/assessments/cov-011-modern-clinician-interface-accessibility.md), [residual coverage and readiness reconciliation](docs/phase-2/assessments/cov-012-019-residual-coverage-and-readiness.md), and [runtime, recovery, deployment, identity-scope, FHIR, and synthetic-laboratory readiness](docs/phase-2/assessments/cov-014-019-runtime-readiness.md). Engineering evidence is substantially collected and all twelve target-policy defaults are approved. Qualified specialist evidence, recommendation acceptance, current production-topology proof, and explicit gate closure remain pending in the [Phase 2 exit gate](docs/phase-2/phase-2-exit-gate.md). The repository-scoped `avanchart-phase-2-assessment` skill applies the same contract in future review sessions.

The workbench also includes a continuous [external feedback challenge](docs/phase-2/external-feedback/README.md). Substantive criticism from public technical discussions is captured as a sourced hypothesis, mapped to existing Phase 2 coverage, challenged through the read-only specialist and verifier model, and linked to canonical findings and recommendations only when the evidence supports it.

## Feature specifications

The [immediate telehealth master specification](docs/telehealth/README.md) defines the practice-branded Georgia, California, and Florida release, including new-patient onboarding, clinical triage, queues, video consultation, prescribing, claims, architecture, security, accessibility, testing, and rollout gates. Disabled synthetic increments now carry local automated evidence through prospective identity review, universal safety screening, controlled migraine/sleep visit-purpose capture, a versioned practice-level plan fixture, a protected mask-only member-insurance receipt, normalized standards-shaped synthetic eligibility and practice-network results, an opaque-reference-only identity-proofing fixture, administrator-authorized atomic creation of a minimal portal-disabled patient shell, state-notice acknowledgment, bounded registration, insurance, communication, device and clinical-information receipts, a five-section pre-request readiness acknowledgment, and one immutable practice-intake review work item, as well as the established-patient queue, connection-room, consultation-draft, wrap-up, pharmacy, safety-disposition, completion-review, and prescription-preparation paths. They remain development slices only. The practice work item is merely `PendingPracticeReview`: it is not practice acceptance, a telehealth request, a doctor search, a patient or clinician care queue, a queue position, an appointment, an encounter, prescribing, billing, a claim, integration, or care authority. The prospective path establishes no identity assurance, legal consent, confirmed negative, clinician reconciliation, completed intake, clinical eligibility, technology readiness, fulfilled support, rendering-physician network participation, aggregate exact-network confirmation, or canonical coverage; no real X12, FHIR, payer, directory, pharmacy, identity-provider, media, production integration, or patient-care action occurs. The clinical, legal, identity-vendor, payer, privacy, security, accessibility, operational, and program-owner approvals identified by the specification remain mandatory before any production use.
